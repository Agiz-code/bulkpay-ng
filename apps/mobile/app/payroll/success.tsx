...
export default function PayrollSuccessScreen() {
  ...
  const employeeCountValue = Number(employeeCount ?? 0);
  ...
  return (
    <View style={styles.container}>
      ...
      <Card style={styles.detailsCard}>
        ...
        <Text style={styles.amount}>₦{amountValue.toLocaleString()}</Text>

        <Text style={styles.label}>Employees Paid</Text>
        <Text style={styles.meta}>{employeeCountValue} team members</Text>
      </Card>
